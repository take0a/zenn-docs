...
erDiagram
    ...
    customer_revenue_by_day |o--|| customer
    customer_revenue_by_day {
        customer_id INT "Customer id"
        revenue DOUBLE "Revenue from orders made by this customer"
        ds TEXT "Date"
    }
    waiter_revenue_by_day |o--|| waiter_name
    waiter_revenue_by_day {
        waiter_id INT "Waiter id"
        revenue DOUBLE "Revenue from orders taken by this waiter"
        ds TEXT "Order date"
    }
    top_waiter |o--|| waiter_name
    top_waiters {
        waiter_id INT
        waiter_name TEXT
        revenue DOUBLE

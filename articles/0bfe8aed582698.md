...
ここは、nodes の枝でサブタイプに分岐します。
このオブジェクトは、 Union[[Seed](#seed), [Analysis](#analysis), [SingularTest](#singulartest), [HookNode](#hooknodeoperation), [Model](#model), [SqlOperation](#sqloperation), [GenericTest](#generictest), [Snapshot](#snapshot)]
...
このオブジェクトは、Union[[ManifestResource](#manifestresource), [SourceDefinition](#sourcedefinition), [Exposure](#exposure), [Metric](#metric), [SavedQuery](#savedquery), [SemanticModel](#semanticmodel), [UnitTestDefinition](#unittestdefinition)]

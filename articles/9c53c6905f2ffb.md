...
Connection id:          175
Current database:       agra
Current user:           agra@10.48.149.170
SSL:                    Not in use
Current pager:          stdout
Using outfile:          ''
Using delimiter:        ;
...
Server version:         10.6.10-MariaDB-log managed by https://aws.amazon.com/rds/
Protocol version:       10
Connection:             maria.c1d39ie3y12s.ap-northeast-1.rds.amazonaws.com via TCP/IP
Server characterset:    latin1
Db     characterset:    utf8mb3
Client characterset:    utf8mb3
Conn.  characterset:    utf8mb3
...
RDS の MariaDB は、文字コードセットの初期値が latin1 のようなので、utf8mb3 に変更しておきます。
